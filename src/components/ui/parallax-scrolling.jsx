      ...
      <section className="parallax__header">
        <div className="parallax__visuals">
          ...
          <div data-parallax-layers className="parallax__layers">
            <img src={layer1} loading="eager" width="800" data-parallax-layer="1" alt="" className="parallax__layer-img" />
            <img src={layer2} loading="eager" width="800" data-parallax-layer="2" alt="" className="parallax__layer-img" />
            <div data-parallax-layer="3" className="parallax__layer-title">
              <h2 className="parallax__title">{title}</h2>
            </div>
            <img src={layer4} loading="eager" width="800" data-parallax-layer="4" alt="" className="parallax__layer-img" />
          </div>
